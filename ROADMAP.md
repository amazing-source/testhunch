...
- [ ] Arbitrer ce qu'un candidat peut céder sur la mesure principale pour franchir le garde-fou — après LRTS, pas avant. **L'échange est désormais mesuré et non supposé** ([phase 6](benchmarks/results/study/learned.md)) : environ 0,03 d'APFDc achète 0,22 de position sur les premiers échecs, et aucun des trois agencements du modèle appris ne garde les deux
